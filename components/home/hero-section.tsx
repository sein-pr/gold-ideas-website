    ...
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl items-center px-6 lg:px-8">
        <div className="max-w-2xl py-32 lg:py-40">
          ...
          >
            <span className="text-balance">Where Namibian Spirit Meets</span>{" "}
            <span className="italic text-accent">Timeless Craft</span>
          </motion.h1>
          ...
          >
            Three-dimensional masterpieces handcrafted from Namibian gemstones, gold, and
            the extraordinary. Every piece tells a story of heritage and artistry.
          </motion.p>
